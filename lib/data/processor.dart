import 'dart:async';
import 'package:flutter_calc/repository/key.dart';
import 'package:flutter_calc/repository/key_controller.dart';
import 'package:flutter_calc/repository/key_symbol.dart';
...
abstract class Processor {
  ...
  static StreamSubscription listen(Function handler) =>
      _stream.listen(handler as void Function(dynamic event)?);
